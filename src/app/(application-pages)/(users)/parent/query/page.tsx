                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <CardTitle className="text-base">
                        {query.senderRole === "PARENT" ? "You" : query.tutor?.user.fullname}
                      </CardTitle>
            ...
            {selectedQuery && (
              <>
                <div className="flex flex-col gap-1 p-3 rounded-lg bg-muted/50">
                  <div className="flex justify-between items-center text-xs text-muted-foreground">
                    <span className="font-semibold text-foreground">
                      {selectedQuery.senderRole === "PARENT" ? "You" : selectedQuery.tutor?.user.fullname}
                    </span>
                ...
                {selectedQuery.responses.map((response) => (
                  <div key={response.id} className={`flex flex-col gap-1 p-3 rounded-lg ${response.senderRole === "PARENT" ? "bg-primary/10 ml-8" : "bg-muted/50 mr-8"}`}>
                    <div className="flex justify-between items-center text-xs text-muted-foreground">
                      <span className="font-semibold text-foreground">
                        {response.senderRole === "PARENT" ? "You" : selectedQuery.tutor?.user.fullname}
                      </span>
