...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root
      ...
      className={cn(
        "group/navigation-menu relative flex max-w-max flex-1 items-center font-semibold justify-center",
        className
      )}
      {...props}
    >
